    ...
    function init() {
        ...
        document.getElementById("mainFrame").addEventListener('mousemove', onPointerMove);
        addEventListener('mouseup', onPointerUp);
        //document.getElementById("mainFrame").addEventListener('wheel', onDocumentMouseWheel);
